...
exports.POS = exports.TransbankPOSWebSocket = void 0;
...
class TransbankPOSWebSocket {
  constructor() {
    ...
    this.timeout = 90000;
    this.channels = ["listPorts", "closeDay", "refund", "getTotals", "setNormalMode", "getDetails", "getPortStatus", "openPort", "closePort", "doSale", "getKeys", "getLastSale"];
    this.isConnected = false;
  }

  connect() {
    let socketJsUrl = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "http://localhost:8090/tbk-sdk-java-websocket";
  ...
  async getDetails() {
    let printOrPos = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
...
exports.TransbankPOSWebSocket = TransbankPOSWebSocket;
